...
class PermutableSkinnerScanSelectTranslator : public OperatorTranslator {
 public:
  PermutableSkinnerScanSelectTranslator(
      const plan::SkinnerScanSelectOperator& scan_select,
      khir::ProgramBuilder& program);
  virtual ~PermutableSkinnerScanSelectTranslator() = default;
