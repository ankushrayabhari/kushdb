...
kush::catalog::Database EnumSchema() {
...

  {
    ...
    auto s_name_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/s_name_enum.kdbenum");
    table.Insert("s_name", Type::Enum(s_name_enum),
                 "benchmark/tpch1/data/s_name_enum.kdb", "",
                 "benchmark/tpch1/data/s_name_enum.kdbindex");
    auto s_address_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/s_address_enum.kdbenum");
    table.Insert("s_address", Type::Enum(s_address_enum),
                 "benchmark/tpch1/data/s_address_enum.kdb", "",
                 "benchmark/tpch1/data/s_address_enum.kdbindex");
    table.Insert("s_nationkey", Type::Int(),
                 "benchmark/tpch1/data/s_nationkey.kdb", "",
                 "benchmark/tpch1/data/s_nationkey.kdbindex");
    auto s_phone_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/s_phone_enum.kdbenum");
    table.Insert("s_phone", Type::Enum(s_phone_enum),
                 "benchmark/tpch1/data/s_phone_enum.kdb", "",
                 "benchmark/tpch1/data/s_phone_enum.kdbindex");
    table.Insert("s_acctbal", Type::Real(),
                 "benchmark/tpch1/data/s_acctbal.kdb", "",
                 "benchmark/tpch1/data/s_acctbal.kdbindex");
    auto s_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/s_comment_enum.kdbenum");
    table.Insert("s_comment", Type::Enum(s_comment_enum),
                 "benchmark/tpch1/data/s_comment_enum.kdb", "",
                 "benchmark/tpch1/data/s_comment_enum.kdbindex");
  }

  {
    ...
    auto p_name_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_name_enum.kdbenum");
    table.Insert("p_name", Type::Enum(p_name_enum),
                 "benchmark/tpch1/data/p_name_enum.kdb", "",
                 "benchmark/tpch1/data/p_name_enum.kdbindex");

    auto p_mfgr_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_mfgr_enum.kdbenum");
    table.Insert("p_mfgr", Type::Enum(p_mfgr_enum),
                 "benchmark/tpch1/data/p_mfgr_enum.kdb", "",
                 "benchmark/tpch1/data/p_mfgr_enum.kdbindex");

    auto p_brand_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_brand_enum.kdbenum");
    table.Insert("p_brand", Type::Enum(p_brand_enum),
                 "benchmark/tpch1/data/p_brand_enum.kdb", "",
                 "benchmark/tpch1/data/p_brand_enum.kdbindex");

    auto p_type_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_type_enum.kdbenum");
    table.Insert("p_type", Type::Enum(p_type_enum),
                 "benchmark/tpch1/data/p_type_enum.kdb", "",
                 "benchmark/tpch1/data/p_type_enum.kdbindex");

    table.Insert("p_size", Type::Int(), "benchmark/tpch1/data/p_size.kdb", "",
                 "benchmark/tpch1/data/p_size.kdbindex");

    auto p_container_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_container_enum.kdbenum");
    table.Insert("p_container", Type::Enum(p_container_enum),
                 "benchmark/tpch1/data/p_container_enum.kdb", "",
                 "benchmark/tpch1/data/p_container_enum.kdbindex");
    ...
    auto p_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/p_comment_enum.kdbenum");
    table.Insert("p_comment", Type::Enum(p_comment_enum),
                 "benchmark/tpch1/data/p_comment_enum.kdb", "",
                 "benchmark/tpch1/data/p_comment_enum.kdbindex");
  }

  {
    ...
    auto ps_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/ps_comment_enum.kdbenum");
    table.Insert("ps_comment", Type::Enum(ps_comment_enum),
                 "benchmark/tpch1/data/ps_comment_enum.kdb", "",
                 "benchmark/tpch1/data/ps_comment_enum.kdbindex");
  }

  {
    ...
    auto c_name_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/c_name_enum.kdbenum");
    table.Insert("c_name", Type::Enum(c_name_enum),
                 "benchmark/tpch1/data/c_name_enum.kdb", "",
                 "benchmark/tpch1/data/c_name_enum.kdbindex");
    auto c_address_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/c_address_enum.kdbenum");
    table.Insert("c_address", Type::Enum(c_address_enum),
                 "benchmark/tpch1/data/c_address_enum.kdb", "",
                 "benchmark/tpch1/data/c_address_enum.kdbindex");
    table.Insert("c_nationkey", Type::Int(),
                 "benchmark/tpch1/data/c_nationkey.kdb", "",
                 "benchmark/tpch1/data/c_nationkey.kdbindex");
    auto c_phone_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/c_phone_enum.kdbenum");
    table.Insert("c_phone", Type::Enum(c_phone_enum),
                 "benchmark/tpch1/data/c_phone_enum.kdb", "",
                 "benchmark/tpch1/data/c_phone_enum.kdbindex");
    table.Insert("c_acctbal", Type::Real(),
                 "benchmark/tpch1/data/c_acctbal.kdb", "",
                 "benchmark/tpch1/data/c_acctbal.kdbindex");
    auto c_mktsegment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/c_mktsegment_enum.kdbenum");
    table.Insert("c_mktsegment", Type::Enum(c_mktsegment_enum),
                 "benchmark/tpch1/data/c_mktsegment_enum.kdb", "",
                 "benchmark/tpch1/data/c_mktsegment_enum.kdbindex");
    auto c_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/c_comment_enum.kdbenum");
    table.Insert("c_comment", Type::Enum(c_comment_enum),
                 "benchmark/tpch1/data/c_comment_enum.kdb", "",
                 "benchmark/tpch1/data/c_comment_enum.kdbindex");
  }

  {
    ...
    auto o_orderstatus_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/o_orderstatus_enum.kdbenum");
    table.Insert("o_orderstatus", Type::Enum(o_orderstatus_enum),
                 "benchmark/tpch1/data/o_orderstatus_enum.kdb", "",
                 "benchmark/tpch1/data/o_orderstatus_enum.kdbindex");
    table.Insert("o_totalprice", Type::Real(),
                 "benchmark/tpch1/data/o_totalprice.kdb", "",
                 "benchmark/tpch1/data/o_totalprice.kdbindex");
    table.Insert("o_orderdate", Type::Date(),
    ...
    auto o_orderpriority_enum =
        kush::runtime::Enum::EnumManager::Get().Register(
            "benchmark/tpch1/data/o_orderpriority_enum.kdbenum");
    table.Insert("o_orderpriority", Type::Enum(o_orderpriority_enum),
                 "benchmark/tpch1/data/o_orderpriority_enum.kdb", "",
                 "benchmark/tpch1/data/o_orderpriority_enum.kdbindex");
    auto o_clerk_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/o_clerk_enum.kdbenum");
    table.Insert("o_clerk", Type::Enum(o_clerk_enum),
                 "benchmark/tpch1/data/o_clerk_enum.kdb", "",
                 "benchmark/tpch1/data/o_clerk_enum.kdbindex");
    table.Insert("o_shippriority", Type::Int(),
                 "benchmark/tpch1/data/o_shippriority.kdb", "",
                 "benchmark/tpch1/data/o_shippriority.kdbindex");
    auto o_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/o_comment_enum.kdbenum");
    table.Insert("o_comment", Type::Enum(o_comment_enum),
                 "benchmark/tpch1/data/o_comment_enum.kdb", "",
                 "benchmark/tpch1/data/o_comment_enum.kdbindex");
  }

  {
    ...
    auto l_returnflag_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/l_returnflag_enum.kdbenum");
    table.Insert("l_returnflag", Type::Enum(l_returnflag_enum),
                 "benchmark/tpch1/data/l_returnflag_enum.kdb", "",
                 "benchmark/tpch1/data/l_returnflag_enum.kdbindex");

    auto l_linestatus_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/l_linestatus_enum.kdbenum");
    table.Insert("l_linestatus", Type::Enum(l_linestatus_enum),
                 "benchmark/tpch1/data/l_linestatus_enum.kdb", "",
                 "benchmark/tpch1/data/l_linestatus_enum.kdbindex");
    ...
    auto l_shipinstruct_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/l_shipinstruct_enum.kdbenum");
    table.Insert("l_shipinstruct", Type::Enum(l_shipinstruct_enum),
                 "benchmark/tpch1/data/l_shipinstruct_enum.kdb", "",
                 "benchmark/tpch1/data/l_shipinstruct_enum.kdbindex");

    auto l_shipmode_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/l_shipmode_enum.kdbenum");
    table.Insert("l_shipmode", Type::Enum(l_shipmode_enum),
                 "benchmark/tpch1/data/l_shipmode_enum.kdb", "",
                 "benchmark/tpch1/data/l_shipmode_enum.kdbindex");

    auto l_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/l_comment_enum.kdbenum");
    table.Insert("l_comment", Type::Enum(l_comment_enum),
                 "benchmark/tpch1/data/l_comment_enum.kdb", "",
                 "benchmark/tpch1/data/l_comment_enum.kdbindex");
  }

  {
    ...
    auto n_name_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/n_name_enum.kdbenum");
    table.Insert("n_name", Type::Enum(n_name_enum),
                 "benchmark/tpch1/data/n_name_enum.kdb", "",
                 "benchmark/tpch1/data/n_name_enum.kdbindex");
    table.Insert("n_regionkey", Type::Int(),
                 "benchmark/tpch1/data/n_regionkey.kdb", "",
                 "benchmark/tpch1/data/n_regionkey.kdbindex");
    auto n_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/n_comment_enum.kdbenum");
    table.Insert("n_comment", Type::Enum(n_comment_enum),
                 "benchmark/tpch1/data/n_comment_enum.kdb", "",
                 "benchmark/tpch1/data/n_comment_enum.kdbindex");
  }

  {
    ...
    auto r_name_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/r_name_enum.kdbenum");
    table.Insert("r_name", Type::Enum(r_name_enum),
                 "benchmark/tpch1/data/r_name_enum.kdb", "",
                 "benchmark/tpch1/data/r_name_enum.kdbindex");
    auto r_comment_enum = kush::runtime::Enum::EnumManager::Get().Register(
        "benchmark/tpch1/data/r_comment_enum.kdbenum");
    table.Insert("r_comment", Type::Enum(r_comment_enum),
                 "benchmark/tpch1/data/r_comment_enum.kdb", "",
                 "benchmark/tpch1/data/r_comment_enum.kdbindex");
  }
