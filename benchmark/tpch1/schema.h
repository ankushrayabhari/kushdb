...
kush::catalog::Database Schema() {
...

  {
    ...
    table.Insert("s_suppkey", SqlType::INT,
                 "benchmark/tpch1/data/s_suppkey.kdb", "",
                 "benchmark/tpch1/data/s_suppkey.kdbindex");
    table.Insert("s_name", SqlType::TEXT, "benchmark/tpch1/data/s_name.kdb", "",
    ...
    table.Insert("s_phone", SqlType::TEXT, "benchmark/tpch1/data/s_phone.kdb",
...

  {
    ...
    table.Insert("p_partkey", SqlType::INT,
                 "benchmark/tpch1/data/p_partkey.kdb", "",
                 "benchmark/tpch1/data/p_partkey.kdbindex");
    table.Insert("p_name", SqlType::TEXT, "benchmark/tpch1/data/p_name.kdb", "",
                 "benchmark/tpch1/data/p_name.kdbindex");
    table.Insert("p_mfgr", SqlType::TEXT, "benchmark/tpch1/data/p_mfgr.kdb", "",
                 "benchmark/tpch1/data/p_mfgr.kdbindex");
    table.Insert("p_brand", SqlType::TEXT, "benchmark/tpch1/data/p_brand.kdb",
                 "", "benchmark/tpch1/data/p_brand.kdbindex");
    table.Insert("p_type", SqlType::TEXT, "benchmark/tpch1/data/p_type.kdb", "",
                 "benchmark/tpch1/data/p_type.kdbindex");
    table.Insert("p_size", SqlType::INT, "benchmark/tpch1/data/p_size.kdb", "",
...

  {
    ...
    table.Insert("c_custkey", SqlType::INT,
                 "benchmark/tpch1/data/c_custkey.kdb", "",
                 "benchmark/tpch1/data/c_custkey.kdbindex");
    table.Insert("c_name", SqlType::TEXT, "benchmark/tpch1/data/c_name.kdb", "",
    ...
    table.Insert("c_phone", SqlType::TEXT, "benchmark/tpch1/data/c_phone.kdb",
...

  {
    ...
    table.Insert("o_custkey", SqlType::INT,
                 "benchmark/tpch1/data/o_custkey.kdb", "",
    ...
    table.Insert("o_clerk", SqlType::TEXT, "benchmark/tpch1/data/o_clerk.kdb",
...

  {
    ...
    table.Insert("l_tax", SqlType::REAL, "benchmark/tpch1/data/l_tax.kdb", "",
...

  {
    ...
    table.Insert("n_name", SqlType::TEXT, "benchmark/tpch1/data/n_name.kdb", "",
...

  {
    ...
    table.Insert("r_name", SqlType::TEXT, "benchmark/tpch1/data/r_name.kdb", "",
