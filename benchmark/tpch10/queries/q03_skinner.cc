...
// Select(l_shipdate > '1995-03-03')
std::unique_ptr<Operator> SelectLineitem() {
  auto lineitem = ScanLineitem();
  auto gt =
      Gt(ColRef(lineitem, "l_shipdate"), Literal(absl::CivilDay(1995, 3, 3)));
...
int main(int argc, char** argv) {
  ...
  BenchVerify(*query, "benchmark/tpch10/raw/q03.tbl");
  return 0;
}
