...
// Select(o_orderdate >= '1994-02-01' and o_orderdate < '1994-05-01')
std::unique_ptr<Operator> SelectOrders() {
  ...
  auto geq =
      Exp(Geq(VirtColRef(scan_schema, "o_orderdate"), Literal(1994, 2, 1)));
  auto lt =
      Exp(Lt(VirtColRef(scan_schema, "o_orderdate"), Literal(1994, 5, 1)));
