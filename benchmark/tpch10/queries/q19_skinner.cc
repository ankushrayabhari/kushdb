...
std::unique_ptr<Operator> SelectPart() {
  ...
  std::unique_ptr<Expression> or3;
  {
    ...
    std::unique_ptr<Expression> p3 =
        Eq(ColRef(part, "p_brand"), Literal("Brand#43"sv));
    std::unique_ptr<Expression> p4 =
...
std::unique_ptr<Operator> SelectLineitem() {
  ...
  {
    std::unique_ptr<Expression> p1 =
        Geq(ColRef(lineitem, "l_quantity"), Literal(5.0));
    std::unique_ptr<Expression> p2 =
        Leq(ColRef(lineitem, "l_quantity"), Literal(15.0));
    std::unique_ptr<Expression> p3 =
        Geq(ColRef(lineitem, "l_quantity"), Literal(16.0));
    std::unique_ptr<Expression> p4 =
        Leq(ColRef(lineitem, "l_quantity"), Literal(26.0));
    std::unique_ptr<Expression> p5 =
...
int main(int argc, char** argv) {
  ...
  BenchVerify(*query, "benchmark/tpch10/raw/q19.tbl");
  return 0;
}
