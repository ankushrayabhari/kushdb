...
std::unique_ptr<Operator> SelectPart() {
  ...
  std::unique_ptr<Expression> or1;
  {
    ...
    std::unique_ptr<Expression> p3 =
        Eq(VirtColRef(scan_schema, "p_brand"), Literal("Brand#12"sv));
  ...
  std::unique_ptr<Expression> or2;
  {
    ...
    std::unique_ptr<Expression> p3 =
        Eq(VirtColRef(scan_schema, "p_brand"), Literal("Brand#22"sv));
    std::unique_ptr<Expression> p4 =
  ...
  std::unique_ptr<Expression> or3;
  {
    ...
    std::unique_ptr<Expression> p3 =
        Eq(VirtColRef(scan_schema, "p_brand"), Literal("Brand#43"sv));
    std::unique_ptr<Expression> p4 =
...
std::unique_ptr<Operator> SelectLineitem() {
  ...
  {
    std::unique_ptr<Expression> p1 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(5.0));
    std::unique_ptr<Expression> p2 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(15.0));
    std::unique_ptr<Expression> p3 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(16.0));
    std::unique_ptr<Expression> p4 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(26.0));
    std::unique_ptr<Expression> p5 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(24.0));
    std::unique_ptr<Expression> p6 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(34.0));
...
std::unique_ptr<Operator> SelectPartLineitem() {
  ...
  std::unique_ptr<Expression> or1;
  {
    ...
    std::unique_ptr<Expression> p8 =
        Geq(ColRef(base, "l_quantity"), Literal(5.0));
    std::unique_ptr<Expression> p9 =
        Leq(ColRef(base, "l_quantity"), Literal(15.0));
    or1 =
  ...
  std::unique_ptr<Expression> or2;
  {
    ...
    std::unique_ptr<Expression> p8 =
        Geq(ColRef(base, "l_quantity"), Literal(16.0));
    std::unique_ptr<Expression> p9 =
        Leq(ColRef(base, "l_quantity"), Literal(26.0));
    or2 =
        And(util::MakeVector(std::move(p1), std::move(p2), std::move(p3),
                             Or(util::MakeVector(std::move(p4), std::move(p5),
                                                 std::move(p6), std::move(p7))),
  ...
  std::unique_ptr<Expression> or3;
  {
    ...
    std::unique_ptr<Expression> p3 =
        Eq(ColRef(base, "p_brand"), Literal("Brand#43"sv));
    std::unique_ptr<Expression> p4 =
