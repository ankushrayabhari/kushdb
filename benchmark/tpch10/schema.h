...
kush::catalog::Database RegularSchema() {
...

  {
    ...
    table.Insert("s_name", Type::Text(), "benchmark/tpch10/data/s_name.kdb", "",
    ...
    table.Insert("s_phone", Type::Text(), "benchmark/tpch10/data/s_phone.kdb",
...

  {
    ...
    table.Insert("p_name", Type::Text(), "benchmark/tpch10/data/p_name.kdb", "",
                 "benchmark/tpch10/data/p_name.kdbindex");
    table.Insert("p_mfgr", Type::Text(), "benchmark/tpch10/data/p_mfgr.kdb", "",
                 "benchmark/tpch10/data/p_mfgr.kdbindex");
    table.Insert("p_brand", Type::Text(), "benchmark/tpch10/data/p_brand.kdb",
                 "", "benchmark/tpch10/data/p_brand.kdbindex");
    table.Insert("p_type", Type::Text(), "benchmark/tpch10/data/p_type.kdb", "",
...

  {
    ...
    table.Insert("c_name", Type::Text(), "benchmark/tpch10/data/c_name.kdb", "",
    ...
    table.Insert("c_phone", Type::Text(), "benchmark/tpch10/data/c_phone.kdb",
...

  {
    ...
    table.Insert("o_clerk", Type::Text(), "benchmark/tpch10/data/o_clerk.kdb",
...

  {
    ...
    table.Insert("n_name", Type::Text(), "benchmark/tpch10/data/n_name.kdb", "",
...

  {
    ...
    table.Insert("r_name", Type::Text(), "benchmark/tpch10/data/r_name.kdb", "",
