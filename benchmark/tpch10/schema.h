...
kush::catalog::Database Schema() {
...

  {
    ...
    table.Insert("s_name", SqlType::TEXT, "benchmark/tpch10/data/s_name.kdb",
                 "", "benchmark/tpch10/data/s_name.kdbindex");
    table.Insert("s_address", SqlType::TEXT,
                 "benchmark/tpch10/data/s_address.kdb", "",
                 "benchmark/tpch10/data/s_address.kdbindex");
    table.Insert("s_nationkey", SqlType::INT,
                 "benchmark/tpch10/data/s_nationkey.kdb", "",
                 "benchmark/tpch10/data/s_nationkey.kdbindex");
    table.Insert("s_phone", SqlType::TEXT, "benchmark/tpch10/data/s_phone.kdb",
                 "", "benchmark/tpch10/data/s_phone.kdbindex");
    ...
    table.Insert("s_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/s_comment.kdb", "",
                 "benchmark/tpch10/data/s_comment.kdbindex");
  }

  {
    ...
    table.Insert("p_name", SqlType::TEXT, "benchmark/tpch10/data/p_name.kdb",
                 "", "benchmark/tpch10/data/p_name.kdbindex");
    table.Insert("p_mfgr", SqlType::TEXT, "benchmark/tpch10/data/p_mfgr.kdb",
                 "", "benchmark/tpch10/data/p_mfgr.kdbindex");
    table.Insert("p_brand", SqlType::TEXT, "benchmark/tpch10/data/p_brand.kdb",
                 "", "benchmark/tpch10/data/p_brand.kdbindex");
    table.Insert("p_type", SqlType::TEXT, "benchmark/tpch10/data/p_type.kdb",
                 "", "benchmark/tpch10/data/p_type.kdbindex");
    table.Insert("p_size", SqlType::INT, "benchmark/tpch10/data/p_size.kdb", "",
                 "benchmark/tpch10/data/p_size.kdbindex");
    table.Insert("p_container", SqlType::TEXT,
                 "benchmark/tpch10/data/p_container.kdb", "",
                 "benchmark/tpch10/data/p_container.kdbindex");
    ...
    table.Insert("p_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/p_comment.kdb", "",
                 "benchmark/tpch10/data/p_comment.kdbindex");
  }

  {
    ...
    table.Insert("ps_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/ps_comment.kdb", "",
                 "benchmark/tpch10/data/ps_comment.kdbindex");
  }

  {
    ...
    table.Insert("c_name", SqlType::TEXT, "benchmark/tpch10/data/c_name.kdb",
                 "", "benchmark/tpch10/data/c_name.kdbindex");
    table.Insert("c_address", SqlType::TEXT,
                 "benchmark/tpch10/data/c_address.kdb", "",
                 "benchmark/tpch10/data/c_address.kdbindex");
    table.Insert("c_nationkey", SqlType::INT,
                 "benchmark/tpch10/data/c_nationkey.kdb", "",
                 "benchmark/tpch10/data/c_nationkey.kdbindex");
    table.Insert("c_phone", SqlType::TEXT, "benchmark/tpch10/data/c_phone.kdb",
                 "", "benchmark/tpch10/data/c_phone.kdbindex");
    ...
    table.Insert("c_mktsegment", SqlType::TEXT,
                 "benchmark/tpch10/data/c_mktsegment.kdb", "",
                 "benchmark/tpch10/data/c_mktsegment.kdbindex");
    table.Insert("c_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/c_comment.kdb", "",
                 "benchmark/tpch10/data/c_comment.kdbindex");
  }

  {
    ...
    table.Insert("o_orderstatus", SqlType::TEXT,
                 "benchmark/tpch10/data/o_orderstatus.kdb", "",
                 "benchmark/tpch10/data/o_orderstatus.kdbindex");
    ...
    table.Insert("o_orderpriority", SqlType::TEXT,
                 "benchmark/tpch10/data/o_orderpriority.kdb", "",
                 "benchmark/tpch10/data/o_orderpriority.kdbindex");
    table.Insert("o_clerk", SqlType::TEXT, "benchmark/tpch10/data/o_clerk.kdb",
                 "", "benchmark/tpch10/data/o_clerk.kdbindex");
    ...
    table.Insert("o_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/o_comment.kdb", "",
                 "benchmark/tpch10/data/o_comment.kdbindex");
  }

  {
    ...
    table.Insert("l_tax", SqlType::REAL, "benchmark/tpch10/data/l_tax.kdb", "",
                 "benchmark/tpch10/data/l_tax.kdbindex");
    table.Insert("l_returnflag", SqlType::TEXT,
                 "benchmark/tpch10/data/l_returnflag.kdb", "",
                 "benchmark/tpch10/data/l_returnflag.kdbindex");
    table.Insert("l_linestatus", SqlType::TEXT,
                 "benchmark/tpch10/data/l_linestatus.kdb", "",
                 "benchmark/tpch10/data/l_linestatus.kdbindex");
    ...
    table.Insert("l_shipinstruct", SqlType::TEXT,
                 "benchmark/tpch10/data/l_shipinstruct.kdb", "",
                 "benchmark/tpch10/data/l_shipinstruct.kdbindex");
    table.Insert("l_shipmode", SqlType::TEXT,
                 "benchmark/tpch10/data/l_shipmode.kdb", "",
                 "benchmark/tpch10/data/l_shipmode.kdbindex");
    table.Insert("l_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/l_comment.kdb", "",
                 "benchmark/tpch10/data/l_comment.kdbindex");
  }

  {
    ...
    table.Insert("n_name", SqlType::TEXT, "benchmark/tpch10/data/n_name.kdb",
                 "", "benchmark/tpch10/data/n_name.kdbindex");
    ...
    table.Insert("n_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/n_comment.kdb", "",
                 "benchmark/tpch10/data/n_comment.kdbindex");
  }

  {
    ...
    table.Insert("r_name", SqlType::TEXT, "benchmark/tpch10/data/r_name.kdb",
                 "", "benchmark/tpch10/data/r_name.kdbindex");
    table.Insert("r_comment", SqlType::TEXT,
                 "benchmark/tpch10/data/r_comment.kdb", "",
                 "benchmark/tpch10/data/r_comment.kdbindex");
  }
