...
// '1993-01-01' and l_receiptdate < '1994-01-01')
std::unique_ptr<Operator> SelectLineitem() {
  ...
  auto or_1 = Exp(Eq(VirtColRef(scan_schema, "l_shipmode"), Literal("MAIL"sv)));
  auto or_2 =
  ...
  auto p4 =
      Exp(Geq(VirtColRef(scan_schema, "l_receiptdate"), Literal(1993, 1, 1)));
  auto p5 =
      Exp(Lt(VirtColRef(scan_schema, "l_receiptdate"), Literal(1994, 1, 1)));
