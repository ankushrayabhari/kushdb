...
FROM cast_info AS ci,
     ...
     title AS t WHERE t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND ci.note IN ('(writer)',
                  ...
                  'War') AND it1.info = 'genres' AND it2.info = 'votes' AND ci.movie_id = mi_idx.movie_id AND t.id = mi.movie_id AND mi.movie_id = mi_idx.movie_id AND it2.id = mi_idx.info_type_id AND ci.movie_id = mi.movie_id AND it1.id = mi.info_type_id AND t.id = mi_idx.movie_id AND n.id = ci.person_id AND t.id = ci.movie_id;