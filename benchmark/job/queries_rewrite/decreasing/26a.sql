...
FROM complete_cast AS cc,
     ...
     title AS t WHERE ci.person_role_id >= 0 AND ci.person_role_id >= 0 AND ci.person_role_id >= 0 AND ci.person_role_id >= 0 AND ci.person_role_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND n.id >= 0 AND n.id >= 0 AND n.id >= 0 AND n.id >= 0 AND n.id >= 0 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND mi_idx.info > '7.0' AND (chn.name LIKE '%man%'
