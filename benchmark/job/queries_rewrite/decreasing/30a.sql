...
FROM complete_cast AS cc,
     ...
     title AS t WHERE mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND t.production_year > 2000 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND ci.note IN ('(writer)',
                  ...
                  'Thriller') AND k.keyword IN ('murder',
                    ...
                    'hospital') AND cct1.kind IN ('cast',
