...
FROM company_name AS cn,
     ...
     title AS t WHERE mi.info IN ('Sweden',
                  ...
                  'American') AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND ct.id >= 0 AND ct.id >= 0 AND ct.id >= 0 AND ct.id >= 0 AND ct.id >= 0 AND k.keyword IN ('murder',
