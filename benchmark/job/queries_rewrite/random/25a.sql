...
FROM cast_info AS ci,
     ...
     title AS t WHERE it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND mi.info = 'Horror' AND mi.info = 'Horror' AND mi.info = 'Horror' AND mi.info = 'Horror' AND mi.info = 'Horror' AND mi.info = 'Horror' AND ci.note IN ('(writer)',
