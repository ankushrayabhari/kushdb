...
FROM complete_cast AS cc,
     ...
     title AS t WHERE it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND n.gender = 'm' AND mi.info IN ('Horror',
                  ...
                  'Thriller') AND cct1.kind IN ('cast',

                    'crew') AND cct2.kind ='complete+verified' AND k.keyword IN ('murder',
