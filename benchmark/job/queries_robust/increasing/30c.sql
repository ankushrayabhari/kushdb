...
FROM complete_cast AS cc,
     ...
     title AS t WHERE cct1.kind = 'cast' AND cct1.kind = 'cast' AND cct1.kind = 'cast' AND cct1.kind = 'cast' AND cct1.kind = 'cast' AND cct1.kind = 'cast' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND k.keyword IN ('murder',
