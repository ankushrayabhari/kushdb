...
FROM complete_cast AS cc,
     ...
     title AS t WHERE cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND cct2.kind ='complete+verified' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it1.info = 'genres' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND cct1.kind IN ('cast',

                    'crew') AND cct1.kind IN ('cast',
                    ...
                    'hospital') AND t.production_year > 2000 AND (t.title LIKE '%Freddy%'

       OR t.title LIKE '%Jason%'

       OR t.title LIKE 'Saw%') AND mi.info IN ('Horror',
