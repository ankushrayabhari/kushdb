...
FROM complete_cast AS cc,
     ...
     title AS t WHERE cct2.kind = 'complete' AND cct2.kind = 'complete' AND cct2.kind = 'complete' AND cct2.kind = 'complete' AND cct2.kind = 'complete' AND cct2.kind = 'complete' AND ct.kind ='production companies' AND ct.kind ='production companies' AND ct.kind ='production companies' AND ct.kind ='production companies' AND ct.kind ='production companies' AND ct.kind ='production companies' AND k.keyword ='sequel' AND k.keyword ='sequel' AND k.keyword ='sequel' AND k.keyword ='sequel' AND k.keyword ='sequel' AND k.keyword ='sequel' AND cct1.kind IN ('cast',
                    ...
                    'crew') AND lt.link LIKE '%follow%' AND (cn.name LIKE '%Film%'
