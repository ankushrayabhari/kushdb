...
FROM complete_cast AS cc,
     ...
     title AS t WHERE mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mc.note IS NULL AND mc.note IS NULL AND mc.note IS NULL AND mc.note IS NULL AND mc.note IS NULL AND mc.note IS NULL AND cc.status_id >= 0 AND cc.status_id >= 0 AND cc.status_id >= 0 AND cc.status_id >= 0 AND cc.status_id >= 0 AND mi.info IN ('Sweden',
       ...
       OR cn.name LIKE '%Warner%') AND cn.country_code <> '[pl]' AND t.production_year = 1998 AND cct1.kind IN ('cast',
