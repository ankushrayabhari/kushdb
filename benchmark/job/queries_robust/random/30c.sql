...
FROM complete_cast AS cc,
     ...
     title AS t WHERE mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mi_idx.info_type_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND it2.info = 'votes' AND cct1.kind = 'cast' AND k.keyword IN ('murder',
