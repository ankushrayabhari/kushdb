...
FROM cast_info AS ci,
     ...
     title AS t WHERE ci.note IN ('(writer)',
                  ...
                  '(story editor)') AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND t.id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND mk.keyword_id >= 0 AND k.keyword IN ('murder',
                    ...
                    'hospital') AND it1.info = 'genres' AND it2.info = 'votes' AND mi.info IN ('Horror',
