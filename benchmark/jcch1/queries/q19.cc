...
std::unique_ptr<Operator> SelectLineitem() {
  ...
  {
    std::unique_ptr<Expression> p1 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(6.0));
    std::unique_ptr<Expression> p2 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(16.0));
    std::unique_ptr<Expression> p3 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(13.0));
    std::unique_ptr<Expression> p4 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(23.0));
    std::unique_ptr<Expression> p5 =
        Geq(VirtColRef(scan_schema, "l_quantity"), Literal(49.0));
    std::unique_ptr<Expression> p6 =
        Leq(VirtColRef(scan_schema, "l_quantity"), Literal(59.0));
